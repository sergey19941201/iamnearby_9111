...
{
    public class PortfolioAdapter : RecyclerView.Adapter
    {
        private Activity _context;
        private List<string> photos;
        public PortfolioAdapter(List<string> photos, Activity context)
        {
            this.photos = photos;
            _context = context;
        }
        ...
        {
            DisplayPortfolioPhotoActivity.from_expert = false;
