...
{
    public class SpecialistsCategorySearchAdapter : RecyclerView.Adapter
    {
        ...
        Typeface tf;
        public SpecialistsCategorySearchAdapter(List<SearchDisplaying> categories_list, Activity context, Typeface tf)
        {
