...
{
    class DropDownSubCategsAdapterForMap : RecyclerView.Adapter
    {
        ...
        Typeface tf;
        public DropDownSubCategsAdapterForMap(List<SubCategory> dropdown_sub_category_list, Activity context, Typeface tf)
        {
